...
CLEAR: 			
				MOVW     R0, #0               // put bitword of 0 for hexes
				STR      R0, [R3]
				B        END_KEY
...
KEY_3:			
				MOV      R0, #3               // index for array
				BL 		 SEG7_CODE
				LSL 	 R0, #24              // shift to the fourth hex
				STR 	 R0, [R3]             // store the value for the hex
				B 	 	 END_KEY
				
KEY_2:			
				MOV 	 R0, #2
				BL 		 SEG7_CODE
				LSL 	 R0, #16              // shift to the third hex
				STR 	 R0, [R3]
				B 		 END_KEY
...
KEY_1:			
				MOV 	 R0, #1
				BL 		 SEG7_CODE
				LSL 	 R0, #8              // shift to the second hex
				STR 	 R0, [R3]
				B 		 END_KEY
